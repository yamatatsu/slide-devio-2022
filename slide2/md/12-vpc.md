...
## VPC してみる
---
<img src="./assets/press-of-vpc-connector.png" height="500px" />
...
---
<pre data-id="code-animation"><code data-line-numbers="|19-22" class="hljs" data-trim>
import { Stack, StackProps } from "aws-cdk-lib";
import { Construct } from "constructs";
import * as ec2 from "aws-cdk-lib/aws-ec2";
import * as assets from "aws-cdk-lib/aws-ecr-assets";
...
Note:VpcConnectorを使用することでVPCとApp Runnerを繋ぐことができます
---
### [VPC してみる] まとめ

- stack を定義する際に env を指定しよう
- 3 種類の SubnetType を使い分けよう
- NatProvider を設定しよう
